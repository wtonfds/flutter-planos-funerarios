...
@XmlRootElement(name = "ConsultarSituacaoLoteRpsEnvio", namespace = "http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_envio_v03.xsd")
public class ConsultarSituacaoLoteRpsEnvio {

    @XmlElement(name = "Prestador", namespace = "http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_envio_v03.xsd", required = true)
    protected TcIdentificacaoPrestador prestador;
    @XmlElement(name = "Protocolo", namespace = "http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_envio_v03.xsd", required = true)
