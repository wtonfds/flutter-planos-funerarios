...
public class PlanPriceTableDTO {
    private long id;
    private String name;
    private List<PriceTableAgeRangeDTO> ageRanges;

    public PlanPriceTableDTO() {
    }

    public PlanPriceTableDTO(long id, String name) {
        this.id = id;
        this.name = name;
    }
    public PlanPriceTableDTO(long id, String name, List<PriceTableAgeRangeDTO> priceTableAgeRangeDTO) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        PlanPriceTableDTO that = (PlanPriceTableDTO) o;
        return id == that.id &&
