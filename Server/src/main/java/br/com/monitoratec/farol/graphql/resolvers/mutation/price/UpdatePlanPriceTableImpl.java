...
@Component
public class UpdatePlanPriceTableImpl extends BaseResolver implements GraphQLMutationResolver {
    private static final Logger LOGGER = LoggerFactory.getLogger(UpdatePlanPriceTableImpl.class);

    private final PlanPriceTableService service;

    public UpdatePlanPriceTableImpl(PlanPriceTableService service) {
        this.service = service;
    }

    public CompletableFuture<CommonResponseWithPlanPriceTable> updatePlanPriceTable(Long id, PlanPriceTableInput input, DataFetchingEnvironment dataFetchingEnvironment) {
        ...
        super.validateUserPromise(dataFetchingEnvironment).bindToResponsePromise(responsePromise).anyOf(Arrays.asList(AccessingEntity.values()))
                .thenAccept(cachedTrustedToken -> {
                    ...
                    final CommonResponseWithPlanPriceTable response = new CommonResponseWithPlanPriceTable(StatusCodes.Success.PriceTable.UPDATED_PRICE_TABLE, dto);
