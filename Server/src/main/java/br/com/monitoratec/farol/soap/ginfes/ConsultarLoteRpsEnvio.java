...
@XmlRootElement(name = "ConsultarLoteRpsEnvio", namespace = "http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd")
public class ConsultarLoteRpsEnvio {

    @XmlElement(name = "Prestador", namespace = "http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd", required = true)
    protected TcIdentificacaoPrestador prestador;
    @XmlElement(name = "Protocolo", namespace = "http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd", required = true)
