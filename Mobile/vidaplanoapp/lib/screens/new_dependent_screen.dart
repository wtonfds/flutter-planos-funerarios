...
class NewDependentScreen extends StatefulWidget {
  @override
  _NewDependentScreenState createState() => _NewDependentScreenState();
}

class _NewDependentScreenState extends State<NewDependentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Text("Novo Dependente", style: TextStyle(color: HexColor("1a6069"),)),
        actions: <Widget>[
          IconButton(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Image.asset("assets/images/person.png", height: 15.h,),
                  SizedBox(height: 4.h,),
                  Container(
                    width: 82.w,
                    child: Column(
                        ...
                        SizedBox(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Container(
                                ...
                                child: Icon(FontAwesomeIcons.envelope, color: Colors.grey, size: 3.h,)),
                            hintText: "Email",
                            hintStyle: TextStyle(fontSize: 11.sp, color: Colors.grey.withOpacity(0.5)),
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10.0),
